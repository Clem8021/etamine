...
class AddDeviseToUsers < ActiveRecord::Migration[8.0]
  def change
    change_table :users, bulk: true do |t|
      ...
      ## Trackable (décommente si tu veux utiliser)
      ...
      ## Confirmable (décommente si tu veux utiliser)
      ...
      ## Lockable (décommente si tu veux utiliser)
    ...
    # Ajout des indexes uniques si non présents
